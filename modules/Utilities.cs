        ...
        public static async Task UtilitiesHandlerAsync(SocketMessage src)
        {
            ...
            switch (keyword)    //Ensure switch is ordered similarly to command list
            {
                ...
                case "setprefix":
                    ...
                    await Logging.LogAsync($"PREFIX CHANGED TO \"{Program._prefix}\"");
                ...
                case "shutdown":
                    if (args == "confirm")
                    {
                        ...
                        if (shutdownEnabled)
                        {
                            await Logging.LogAsync($"SHUTTING DOWN: ordered by {src.Author.Username}");
                        ...
                        else
                        {
                            ...
                            await Logging.LogAsync($"{src.Author.Username} disabled shutdown safety.");
                        }
                    }
                    else
                    {
